...
KASAI nutzt Supabase Auth + PostgreSQL. Alle App-Daten sind account-gebunden
und durch Row Level Security geschützt.

1. `supabase-schema.sql` im Supabase SQL Editor ausführen.
2. Email/Password Auth in Supabase aktivieren.
3. Optional Google/Apple Provider in Supabase Auth konfigurieren.

Die PWA cached Daten lokal nur für Offline-Fähigkeit. Beim Logout wird der
lokale User-State geleert, damit beim Account-Wechsel keine alten Daten sichtbar
bleiben.
